...
INSERT INTO "Product" (
  ...
  (37, 'vip', 'Custom Car Plate', 'لوحة سيارة مخصصة', 'A custom car plate, one-time purchase.', 'لوحة سيارة مخصصة، شراء لمرة واحدة.', 'Custom Car Plate — get your own custom plate. Costs 5$ One Time.', 'لوحة سيارة مخصصة — احصل على لوحتك الخاصة. التكلفة 5$ لمرة واحدة.', ARRAY['5$ One Time', 'Custom plate text', 'In-game ready']::TEXT[], ARRAY['5$ لمرة واحدة', 'نص مخصص للوحة', 'جاهز داخل اللعبة']::TEXT[], '5$ One Time', 'images/products/vip/plat.webp', NULL, NULL, false, true, 0),
  (38, 'vip', 'Custom Phone Number', 'رقم تليفون مخصص', 'A custom phone number, one-time purchase.', 'رقم تليفون مخصص، شراء لمرة واحدة.', 'Custom Phone Number — get your own custom number. Costs 5$ One Time.', 'رقم تليفون مخصص — احصل على رقمك الخاص. التكلفة 5$ لمرة واحدة.', ARRAY['5$ One Time', 'Custom number', 'In-game ready']::TEXT[], ARRAY['5$ لمرة واحدة', 'رقم مخصص', 'جاهز داخل اللعبة']::TEXT[], '5$ One Time', 'images/products/vip/custom phone numbers.webp', NULL, NULL, false, true, 0),
  (39, 'mlo', 'Al Dente''s', 'أل دينتيز', 'A restaurant, ready for business.', 'مطعم جاهز للشغل.', 'Al Dente''s restaurant — a restaurant. Costs 15$ Monthly.', 'أل دينتيز — مطعم. التكلفة 15$ شهرياً.', ARRAY['15$ Monthly', 'Restaurant location', 'In-game ready']::TEXT[], ARRAY['15$ شهرياً', 'موقع مطعم', 'جاهزة داخل اللعبة']::TEXT[], '15$ Monthly', 'images/products/mlo/prod-1785937000094.webp', 'restaurant', NULL, false, false, 0);
